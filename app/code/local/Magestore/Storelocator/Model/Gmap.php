...
/**
 * Class Magestore_Storelocator_Model_Gmap
 */
class Magestore_Storelocator_Model_Gmap extends Varien_Object
{
    ...
    public function getCoordinates($address)
    {
        ...
        $address = Mage::helper('storelocator')->characterSpecial($address);
    ...
    public function getFormualAddress()
    {
        ...
        if ($address['zipcode'])
            ...
            $str = $address['street'] . ' ' . $address['zipcode'] . ' ' . $address['region'] . ' ' . $address['country'] . ' ' . $address['city'];
        else
            //$str = $address['street'] . ' ' . $address['city'] . ' ' . $address['region'] . ' ' . $address['country'];
            $str = $address['street'] . ' ' . $address['region'] . ' ' . $address['country'] . ' ' . $address['city'];
