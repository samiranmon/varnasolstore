...
/**
 * Class Magestore_Storelocator_Model_System_Config_Upload
 */
class Magestore_Storelocator_Model_System_Config_Upload
{
    /**
    ...
    {
        return Mage::getBaseDir('media') . DS . 'storelocator' . DS . 'images';
    }
    ...
    {
        return Mage::getBaseUrl('media') . 'storelocator/images';
    }
