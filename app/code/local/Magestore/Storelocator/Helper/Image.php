...
/**
 * Class Magestore_Storelocator_Helper_Image
 */
class Magestore_Storelocator_Helper_Image extends Mage_Core_Helper_Abstract
{
        ...
        foreach ($value as $image) {
            ...
            if (!isset($image['value_id'])) {
                ...
                if (!isset($image['removed']) || (isset($image['removed']) && $image['removed'] != 1)) {
                    ...
                    $mod->setData('storelocator_id', $storeId);
    ...
    protected function _getConfig()
    {
        ...
        return Mage::getSingleton('storelocator/system_config_upload');
    }
