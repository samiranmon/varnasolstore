...
/**
 * Class Magestore_Storelocator_Block_Adminhtml_System_Config_Gmap
 */
class Magestore_Storelocator_Block_Adminhtml_System_Config_Gmap extends Mage_Adminhtml_Block_System_Config_Form_Field {
    ...
    protected function _getElementHtml(Varien_Data_Form_Element_Abstract $element) {
		return '
        <script type="text/javascript" src="https://maps.googleapis.com/maps/api/js?key='.Mage::getStoreConfig('storelocator/general/gkey').'&sensor=false"></script>
        <script>
