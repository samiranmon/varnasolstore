...
abstract class Paypal_InContext_Controller_Express_Abstract extends Mage_Core_Controller_Front_Action
{
    /**
            ...
            try {
                ...
                if ($customer && $customer->getId()) {
                   ...
                   /* Mage::getSingleton('customer/session')
                    ->setBeforeAuthUrl(Mage::getUrl('checkout/cart/*', array('_current' => true)));*/
